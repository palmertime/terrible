...
The sources for terrible can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/palmertime/terrible
.. _tarball: https://github.com/palmertime/terrible/tarball/master
